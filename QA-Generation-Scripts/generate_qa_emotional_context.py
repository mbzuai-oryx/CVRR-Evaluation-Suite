    ...
    response = openai.ChatCompletion.create(
        ...
        messages=[
            ...
            },
            {
                "role": "user",
                "content":
                    f"Given a video which contains actions which are dependent on the overall emotional context in the video, with the following detailed caption explaining the events: "
                    f"The caption is: {caption_content}. "
                    "Formulate 20 diverse misleading and reasoning based questions to test whether the model can correctly identify the actions based on the emotional context in the video. "
                    "Additionally, these inquiries must assess the system's ability to accurately identify and reason the actions in accordance with the emotional context depicted in the video. "
                    ...
                    "Also consider asking about the presence of confusing and similar actions that could most likely occur in the video."
                    ...
                    "2. Do not provide answers in the question itself. For example, the ground-truth attribute or component which makes the video scene unusual should never be mentioned in the question itself. "
                    "3. Ensure the questions are concrete and can be entirely addressed using the provided caption. "
                    "4. Do not ask questions whose answer cannot be obtained from the caption. "
                    "5. Do not formulate questions whose answer is not specified in the video & caption. "
